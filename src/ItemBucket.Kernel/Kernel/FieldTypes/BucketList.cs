...
$('pageNumber" + ClientID + @"').innerHTML = pageNumberCount" + ClientID + @" + ' of ' +  responseParsed" + ClientID + @".PageNumbers;
        ...
        protected override void DoRender(HtmlTextWriter output)
        {
            ...
            output.Write(@"<span id='refresh" + this.ClientID + @"' class='hovertext' style='cursor:pointer;display: none;' onMouseOver=""this.style.color='#666'"" onMouseOut=""this.style.color='#000'""> " + " refresh <img width=\"10\" height=\"10\" src=\"/sitecore%20modules/Shell/Sitecore/ItemBuckets/images/refresh.png\" style=\"margin-top: 1px; \">  " + "</span>");
