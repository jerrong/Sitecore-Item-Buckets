...
{
    public class BucketTreeList : MultilistEx
    {
        ...
        protected override Item[] GetItems(Item current)
        {
            ...
            locationFilter = "{110D559F-DEA5-42EA-9C1C-8A5DF7E70EF9}";
...
$('pageNumber" + ClientID + @"').innerHTML = pageNumberCount" + ClientID + @" + ' of ' +  responseParsed" + ClientID + @".PageNumbers;
        ...
        protected override void DoRender(HtmlTextWriter output)
        {
            ...
            output.Write(@"<span style='padding-left:57px;'><strong>Page Number: </strong></span><span id='pageNumber" + this.ClientID + @"'></span>");
