// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MarkAsBucketable.cs" company="Sitecore">
//   Sitecore
// </copyright>
// <summary>
//   Defines the MarkAsBucketable type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sitecore.ItemBucket.Kernel.Commands
{
    ...
    /// <summary>
    /// Mark an Item as a Bucket Command
    /// </summary>
    internal class MarkAsBucketable : Command
    {
        /// <summary>
        /// Execute the Command
        /// </summary>
        ...
        /// <summary>
        /// Run the Command on another Thread
        /// </summary>
        /// <param name="args">
        /// The args.
        /// </param>
