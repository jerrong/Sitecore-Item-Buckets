<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MiniResults.aspx.cs" Inherits="ItemBuckets.MiniResults" %>
...
<head id="Head1" runat="server">
    ...
    <script src="/sitecore%20modules/Shell/Sitecore/ItemBuckets/Scripts/ItemBucketMini.js" type="text/javascript"></script>
    <script src="/sitecore%20modules/Shell/Sitecore/ItemBuckets/Scripts/jquery.tabSlideOut.v1.3.js" type="text/javascript"></script>
    <script type="text/javascript"  src="/sitecore/shell/Override/InsertLink.js"></script>
...
<body style="width:701px; margin:0;">
    <form id="mainform" method="post" runat="server">

     <div id="MainPanel">
      <a id="closeRTEBox" href="#" onclick="scCloseNoLink(); return false;">Close Window</a>    
        <div class="left">
            ...
            <div class="box">
                <div id="ui_element" class="sb_wrapper">
                  <span id="views"><a id="list" class="active list"></a><a id="grid" class="grid"></a></span>
                   <div class="sb_search_container" style="width: 360px;">
